-- Migration 018: Add cat_name to foster_records and update public_adoptable_cats view
ALTER TABLE foster_records ADD COLUMN IF NOT EXISTS cat_name text;
...
SELECT
  ...
  fr.cat_name, -- Added cat_name here
