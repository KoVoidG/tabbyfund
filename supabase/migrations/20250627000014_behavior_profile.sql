-- Migration 014: Extend foster_records with good_with_dogs and litter_trained
ALTER TABLE foster_records
  ADD COLUMN good_with_dogs boolean,
  ADD COLUMN litter_trained boolean;

-- Recreate the public_adoptable_cats view to expose these new fields
