...
## Corpus Check
- 178 files · ~561,857 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 698 nodes · 1033 edges · 60 communities (51 shown, 9 thin omitted)
...
Cohesion: 0.06
Nodes (36): AdminLayout(), metadata, ProfilePage(), stats, VetLayout(), metadata, AuthLayout(), metadata (+28 more)
...
Cohesion: 0.10
Nodes (22): AppLayout(), BottomNav(), items, MobileNav(), MobileNavProps, NotificationBell(), ProfileMenu(), ProfileMenuProps (+14 more)
...
- **Why does `TabbyMascot()` connect `Notifications & Profile` to `Admin & Dashboard Pages`, `Vet Portal`, `Community 34`, `Adoption Experience`, `Donation Flow`, `Package Dependencies`, `Sidebar & Navigation`, `Community 13`, `Community 22`, `Community 26`, `Admin Mock Data`?**
